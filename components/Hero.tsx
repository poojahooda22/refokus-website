...
function Hero() {
  return (
    <div className='w-screen relative pt-[8vw]'>
      <div className=' max-w-screen-xl mx-auto flex flex-col gap-[8vw] px-[5vw] xl:px-0 mt-[20vw] lg:mt-[8vw] xl:mt-0'>
        <div className='flex items-end justify-end '>
          <div className='w-1/2 h-[4vw]'></div>
          <div className='w-[8vw] h-[12vw] sm:w-[4vw] sm:h-[2vw] flex items-center'>
