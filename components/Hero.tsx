...
function Hero() {
  return (
    <div className='w-screen relative pt-[8vw]'>
      <div className=' max-w-screen-xl mx-auto flex flex-col gap-[14vw] px-[5vw] xl:px-0 mt-[20vw] lg:mt-[6vw] xl:mt-0'>
        ...
        <div className='sm:flex items-end justify-between'>
          <div className='text-[12vw] leading-[11vw] sm:text-[6vw] sm:leading-[5vw] lg:text-[9vw] lg:leading-[8vw] uppercase tracking-tighter'>
            <h1>We</h1>
            <h1>make</h1>
            <h1>cool</h1>
            <h1>websites</h1>
          </div>
          <div className='sm:w-1/3 sm:text-[1vw] text-[4vw] mt-[8vw] sm:mt-0 lg:text-[1.2vw]'>
