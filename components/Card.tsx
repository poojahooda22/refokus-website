...
function Card({width, toptitle, toptitle2, start, para}: 
  ...
  return (
    <div className={` ${width} min-h-[24vw] bg-gray rounded-lg py-[1vw] px-[1vw] flex flex-col `}>
        ...
        <div className='down w-full'>
            {
                start === true ? 
                    <>
                        ...
                        <button className='text-[.8vw] px-[1.3vw] py-[.5vw] rounded-full mt-[1vw] border-[1px] border-secondary'>Contact us</button>
                    </>               
                :  null
            }
            {
