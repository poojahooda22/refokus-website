...
function Card({width, toptitle, toptitle2, start, para}: 
  ...
  return (
    <div className={` ${width} min-h-[80vw] sm:min-h-[24vw] bg-gray rounded-lg sm:rounded-3xl py-[4vw] px-[4vw]
         sm:py-[1vw] sm:px-[1vw]
        ...
        <div className='down w-full'>
            {
                start === true ? 
                    <>
                        ...
                        <Link href="/contact">
                            <button className='text-[3vw] sm:text-[.8vw] py-[3vw] px-[5vw] sm:px-[1.3vw] mt-[4vw]
